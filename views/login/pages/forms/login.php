        ...
        <section id="loginUsuario">
            <div class="holderLogin">
                <div class="Login">
                    ...
                    <img class="loginLogo" src="../../../img/logo_principal.svg" alt="">
                    ...
                    Não tem uma conta?  <a href="../../../../views/register/pages/escolha-tipo-usuario.php" class="textoLoginAhref">  Cadastre-se</a>
                    </span>
