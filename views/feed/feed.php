                ...
                <div style="display: flex; width: 100%; height: 100%;">
                    ...
                    <div class="rightSidePost">
                        ...
                        <div class="commentArea">
                            ...
                            <textarea class="TAComentario" oninput="auto_grow(this)" cols="30" rows="10" placeholder="Adicione um comentário!" maxlength="200" name="txtComentar<?php echo $id ?>" id="txtComentar<?php echo $id ?>"></textarea>
