...
<head>
    ...
    <title>Pet iti - Animais perdidos</title>
            ...
            <div class="Meio">
                ...
                <div class="categoriasFeed">
                    ...
                    <div class="esquerdoCAP">
                        ...
                        <h4 class="text-muted">*Você poderá inserir categorias, a fim de auxiliar na busca do seu pet.</h4>
                        <input type="text" placeholder="Ex: Gato Perdido">
                    </div>
                ...
                <div class="criarPost">
                    <img src="assets/images/casinhas.svg" alt="">
                    <div class="faixaPost">
                ...
                <div class="feeds">
                    <?php
                    $contadorPostagem = 0;
                    $url = "http://localhost/petiti/api/publicacoes/perdidos";
